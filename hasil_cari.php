...
?>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div>
            <?php
              $query ="SELECT * FROM barang_out  WHERE tgl BETWEEN '$_POST[dari]' AND '$_POST[sampai]'";
            ?>
          		...
          		<a href="lap_hasil_cariout.php?id=<?php echo base64_encode($query); ?>" data-toggle="tooltip" title="Print"><i class="fa fa-print fa-2x" style="margin-bottom: 10px;padding: 0 0 0 5px;color:#5aab26;"></i></a>
          		<a href="xl_keluar.php?id=<?php echo base64_encode($query); ?>" data-toggle="tooltip" title="Excel"><i class="fa fa-file-excel-o fa-2x" style="margin-bottom: 10px;padding: 0 0 0 5px;color:#5aab26;"></i></a>
              ...
              <div>
                ...
                $sampai  = $_POST['sampai'];
                   ...
                   $query = mysqli_query($con,"SELECT * FROM barang_out  WHERE tgl BETWEEN '$_POST[dari]' AND '$_POST[sampai]'");
                  $hitung = mysqli_num_rows($query);
                  if ($hitung == 0){

                      echo"<div class='alert alert-warning' role='alert'>
                            <strong>Warning!</strong> Data tidak ditemukan.<a href='barang_keluar.php'>Kembali ke Stock</a>
                          </div>";
                  } 
                  else{
