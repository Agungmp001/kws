...
.pagination {float: right;}
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        	<div class="col-md-12">
        		...
        		<a href="#" data-toggle="tooltip" title="Print"><i class="fa fa-print fa-2x" style="margin-bottom: 10px;padding: 0 0 0 5px;color:#5aab26;"></i></a>
                ...
                <form class="form-inline" method="post" action="hasil_cari.php" style="margin-bottom: -6px;">
                  ...
                  <input type="submit" value="cari" class="btn btn-primary" style="height: 25px;font-size: 10px;padding: 3px 10px;">
        	        ...
        	        <table id="example" class="table table-bordered" width="100%">
                      ...
                      <tbody>
                            ...
                            <?php
                                    $query = mysqli_query($con,"SELECT * FROM barang_out ORDER BY id_keluar DESC");
